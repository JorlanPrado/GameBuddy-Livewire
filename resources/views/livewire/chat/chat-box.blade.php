    ...
    <div class="border-b flex flex-col overflow-y-scroll grow h-full">
        ...
        <header class="w-full sticky inset-x-0 flex pb-[5px] pt-[5px] top-0 z-10 bg-white border-b ">
            ...
            <div class="flex w-full items-center px-2 lg:px-4 gap-2 md:gap-5">
                ...
                <a class="shrink-0 lg:hidden" href="http://127.0.0.1:8000/chat">
     ...
     " id="conversation" class="flex flex-col gap-3 p-2.5 overflow-y-auto  flex-grow overscroll-contain overflow-x-hidden w-full my-auto">
            ...
            <div wire:key="{{time().$key}}" @class([ 'max-w-[85%] md:max-w-[78%] flex w-auto gap-2 relative mt-2' , 'ml-auto'=>$message->sender_id=== auth()->id(),
                ...
                {{-- messsage body --}}
                <div @class(['flex flex-wrap text-[15px] rounded-xl p-2.5 flex flex-col text-black bg-[#f6f6f8fb]', 'rounded-bl-none border  bg-purple-500 hover:bg-purple-700 text-white '=>!($message->sender_id=== auth()->id()),
                    ...
                    <div class="ml-auto flex gap-2">
                        <p @class([ 'text-xs ' , 'text-white'=>!($message->sender_id=== auth()->id()),
