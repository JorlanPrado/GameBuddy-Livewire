...
<body class="antialiased">
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid py-2">
            <img src="/img/logo.png" alt="img" class="lovelobby-img mx-3" style="width: 110px;">
            <h1 class="lovelobby-text mt-2" style="color: white;"><b>GameBuddy</b></h1>
    ...
    <div class="text-center">
        <div class="mx-auto" style="margin-top: 250px;">
            <h1 class="text-center" style="font-size: 150px; font-weight: bold; color:white; font-family: system-ui;">
                Start Matching
            </h1>
        </div>
    </div>
