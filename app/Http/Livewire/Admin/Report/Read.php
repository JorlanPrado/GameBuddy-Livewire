...
class Read extends Component
{
    ...
    protected $listeners = ['reportDeleted'];
    ...
    public function render()
    {
        ...
        return view('livewire.admin.report.read', [
            'reports' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Report')) ]);
    }
}
